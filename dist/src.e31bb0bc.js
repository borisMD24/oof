...
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"pageDetail.js":[function(require,module,exports) {
"use strict";
...
},{}],"pageList.js":[function(require,module,exports) {
"use strict";
    ...
    var fetchList = function fetchList(url, argument) {
      ...
      fetch("".concat(finalURL)).then(function (response) {
        ...
        response.results.forEach(function (article) {
          var concat = "";
          article.platforms.forEach(function (platform) {
            concat += platform.platform.name + " ";
          });
          articles += "\n                    <div class=\"cardGame\">\n                      <img class=\"poster\" src=\"".concat(article.background_image, "\"/>\n                      <p>\n                        ").concat(concat, "\n                      </p>\n                      <h1>").concat(article.name, "</h1>\n                      <h2>").concat(article.released, "</h2>\n                      <a href = \"#pagedetail/").concat(article.id, "\">plus de details</a>\n                    </div>\n                  ");
        });
...
var Home = function Home() {
  var fetchList = function fetchList() {
    fetch("https://api.rawg.io/api/games?dates=2021-01-01,2021-12-31").then(function (response) {
      return response.json();
    }).then(function (response) {
      var articles = "";
      response.results.forEach(function (article) {
...
var _default = Home;
exports.default = _default;
},{}],"routeur.js":[function(require,module,exports) {
"use strict";
...
},{"./pageDetail.js":"pageDetail.js","./pageList.js":"pageList.js","./home.js":"home.js"}],"../node_modules/regenerator-runtime/runtime.js":[function(require,module,exports) {
var define;
/**
...
var _routeur = require("./routeur.js");
...
var setRoute = function setRoute() {
  ...
  _routeur.routes[path[0]](pageArgument);
...
},{"./style/index.scss":"style/index.scss","./routeur.js":"routeur.js","regenerator-runtime":"../node_modules/regenerator-runtime/runtime.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
